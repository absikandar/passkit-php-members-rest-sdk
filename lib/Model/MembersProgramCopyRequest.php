...
/**
 * MembersProgramCopyRequest Class Doc Comment
 *
 * @category Class
 * @package  PkIo
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MembersProgramCopyRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'membersProgramCopyRequest';
...
'passTypeIdentifier' => 'getPassTypeIdentifier'    ];
     ...
     * Sets id
     *
     * @param string $id uuid of the program to copy.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name optional name for the new program.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param \PkIo\Model\IoProjectStatus[] $status Status to set the copied program to.
     *
     * @return $this
     */
     ...
     *
     * @param string $passTypeIdentifier Can optionally be provided if setting status to published (requires a prod cert).
     *
     * @return $this
     */
